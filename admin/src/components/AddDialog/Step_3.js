...
export default function Step_1() {
				return(
							<div style={{display: 'flex', alignItems:'center',height: '300px', width:'450px', justifyContent:'space-between', margin: '0px auto'}}>
								<div className={admin.pagesingle} style={{height: "200px", width: "150px"}}>
